...
class OrderDetailModelView(ModelView):
   ...
   list_columns = [
"Id", "Product.ProductName", "Order.ShipName", "UnitPrice", "Quantity"]
   show_columns = [
"Id", "Product.ProductName", "Order.ShipName", "UnitPrice", "Quantity", "Discount", "OrderId", "ProductId"]
   edit_columns = [
